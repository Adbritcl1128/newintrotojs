...
let age = currentYear - birthYear;
 ...
 //     NOTE: You MUST USE an expression for this, it may have more than one operation!
  ...
  firstName = 'alex';
    ...
    let years = (birthYear - 1900);
    let remainder = years % 10;
 ...
 function madlib (a,b,c,d) {
    ...
    if (d === undefined) {
      ...
      return 'I prefer ' + a + ' while I ' + b + ' so that I don\'t ' + c + ' on the ' + d + '.';
}
 /* ******************************************************************
                              Adventure Mode
